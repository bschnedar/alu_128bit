...
HD_PWD='C:/Users/Bschnedar/Downloads/alu_128bit (1)/alu_128bit/alu_128bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_1bit.vds -m64 -mode batch -messageDb vivado.pb -notrace -source alu_1bit.tcl
